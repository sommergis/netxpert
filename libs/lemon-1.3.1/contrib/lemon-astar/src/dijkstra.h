  ...
  public:
    ...
    void start(Node t)
    {
      ...
      if ( !_heap->empty() ) {
        ...
        /*std::cout << "forwardscannedcounter: " << forwardscannedcounter << std::endl;
        std::cout << "forwardreachedcounter: " << forwardreachedcounter << std::endl;
        std::cout << "forwardinsertedcounter: " << forwardinsertedcounter << std::endl;
        std::cout << "forwarddecreasedcounter: " << forwarddecreasedcounter << std::endl;*/
      }
