...
namespace netxpert {
    ...
    *  EXPERIMENTAL --> core/odmlem.h
    */
    class OriginDestinationMatrix2 : public netxpert::ISolver
    {
        public:
            /** Default constructor */
            OriginDestinationMatrix2(netxpert::cnfg::Config& cnfg);

            /** Default destructor */
            virtual ~OriginDestinationMatrix2() {}
