...
#ifndef _SPTree_Dijkstra
 #define _SPTree_Dijkstra/* self-identification: #endif at the end of the file */
...
/*--------------------------------------------------------------------------*/
   ...
   SPTree_Dijkstra( cIndex nmx = 0 , cIndex mmx = 0 , bool Drctd = true );
...
/*--------------------------------------------------------------------------*/
   ...
   {
      return ISPTreePtr(new SPTree_Dijkstra ());
   }
   ISPTreePtr clone () const        // Virtual constructor (copying)
   {
      return ISPTreePtr(new SPTree_Dijkstra (*this));
   }
...
/*--------------------------------------------------------------------------*/
   ...
   SPTree_Dijkstra::FONumber MCFGetFO( void );
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
   ...
   SPTree_Dijkstra::FONumber MCFGetFO( Index ND , cIndex_Set DB );
...
inline MCFClass::Index SPTree_Dijkstra::MCFSNde( cIndex i )
{
 if( DirSPT )
  #if( SPT_STRTN )
   return( Startn[ i ] );
...
inline MCFClass::Index SPTree_Dijkstra::MCFENde( cIndex i )
{
 if( DirSPT )
...
inline MCFClass::CNumber SPTree_Dijkstra::MCFCost( cIndex i )
{
 if( DirSPT )
...
inline MCFClass::FNumber SPTree_Dijkstra::MCFUCap( cIndex i )
{
 #if( ! DYNMC_MCF_SPT )
  cIndex pos = DictM1[ i ];
  #if( SAME_GRPH_SPT )
...
inline MCFClass::FNumber SPTree_Dijkstra::MCFDfct( cIndex i )
{
 #if( USENAME0 )
  cIndex myi = i;
 #else
...
inline bool SPTree_Dijkstra::IsClosedArc( cIndex name )
{
 #if( DYNMC_MCF_SPT )
...
inline bool SPTree_Dijkstra::IsDeletedArc( cIndex name )
{
 return( SPTree_Dijkstra::IsClosedArc( name ) );
 }

/*--------------------------------------------------------------------------*/

inline void SPTree_Dijkstra::SetOrigin( cIndex NewOrg )
{
...
inline void SPTree_Dijkstra::SetDest( cIndex NewDst )
{
  //Johannes Sommer
...
//Johannes Sommer
//inline void SPTree_Dijkstra::SetDest( int i )
//{
//	if ( i == -1)
//	{
...
inline bool SPTree_Dijkstra::Reached( cIndex i )
{
 return( ( Pi[ i ] < Inf<CNumber>() ) && ( Q[ i ] == Inf<MCFClass::Index>() ) );
 }

/*--------------------------------------------------------------------------*/

inline unsigned int* SPTree_Dijkstra::Predecessors( void )
{
 return( NdePrd );
 }
...
inline MCFClass::Index SPTree_Dijkstra::DestN( void )
{
 return( NDsts );
 }
...
inline MCFClass::cIndex_Set SPTree_Dijkstra::Dests( void )
{
 return( DstBse );
 }
...
//Johannes Sommer
inline unsigned int* SPTree_Dijkstra::ArcPredecessors( void )
{
 CalcArcP();
...
//Johannes Sommer
inline void SPTree_Dijkstra::GetArcPredecessors( unsigned int *outArcPrd )
{
...
//Johannes Sommer
inline void SPTree_Dijkstra::GetPredecessors( unsigned int *outPrd )
{
	unsigned int size = MCFClass::MCFnmax()+1;
...
//Johannes Sommer
inline void SPTree_Dijkstra::GetDests( unsigned int *outDstBse )
{
	unsigned int size = MCFClass::MCFnmax()+1;
...
#endif  /* SPTree_Dijkstra.h included */

/*--------------------------------------------------------------------------*/
/*-------------------------- End File SPTree_Dijkstra.h --------------------*/
/*--------------------------------------------------------------------------*/
