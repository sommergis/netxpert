...
/*--------------------------------------------------------------------------*/
   	...
   	//For string input - not C-stream
	virtual inline void LoadDMX( std::string &src , bool IsQuad = false );
...
/** @name Write problem to file
   ...
   //Johannes Sommer
   //virtual inline std::string WriteMCF( std::string &src , int frmt = 0 );
   //virtual inline std::stringstream WriteMCF( ostream &oStrm  , int frmt = 0 );
...
/*--------------------------------------------------------------------------*/
 ...
 //For string input - not C-stream
inline void MCFClass::LoadDMX( std::string &src , bool IsQuad )
{
...
//Johannes Sommer void -> std::string
//inline std::string MCFClass::WriteMCF( std::string &dest , int frmt )
//{
//	std::stringstream s(dest);
...
//inline std::stringstream MCFClass::WriteMCF( ostream &oStrm , int frmt )
//{
// if( ( ! numeric_limits<FNumber>::is_integer ) ||
//     ( ! numeric_limits<CNumber>::is_integer ) )
//  oStrm.precision( 12 );
