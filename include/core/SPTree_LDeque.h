...
#ifndef _SPTree_LDeque
 #define _SPTree_LDeque/* self-identification: #endif at the end of the file */
...
//#define SPT_ALGRTM 1
//Johannes Sommer
//const int SPT_ALGRTM = 1;
//const int LABEL_SETTING = 0;
...
*/
class SPTree_LDeque : public MCFClass, public netxpert::core::ISPTree
{
...
/*--------------------------------------------------------------------------*/
   ...
   SPTree_LDeque( cIndex nmx = 0 , cIndex mmx = 0 , bool Drctd = true );
...
/*--------------------------------------------------------------------------*/
   ...
   SPTree_LDeque::FONumber MCFGetFO( void );
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
   ...
   SPTree_LDeque::FONumber MCFGetFO( Index ND , cIndex_Set DB );
...
inline MCFClass::Index SPTree_LDeque::MCFSNde( cIndex i )
{
 if( DirSPT )
  #if( SPT_STRTN )
   return( Startn[ i ] );
...
inline MCFClass::Index SPTree_LDeque::MCFENde( cIndex i )
{
 if( DirSPT )
...
inline MCFClass::CNumber SPTree_LDeque::MCFCost( cIndex i )
{
 if( DirSPT )
...
inline MCFClass::FNumber SPTree_LDeque::MCFUCap( cIndex i )
{
 #if( ! DYNMC_MCF_SPT )
  cIndex pos = DictM1[ i ];
  #if( SAME_GRPH_SPT )
...
inline MCFClass::FNumber SPTree_LDeque::MCFDfct( cIndex i )
{
 #if( USENAME0 )
  cIndex myi = i;
 #else
...
inline bool SPTree_LDeque::IsClosedArc( cIndex name )
{
 #if( DYNMC_MCF_SPT )
...
inline bool SPTree_LDeque::IsDeletedArc( cIndex name )
{
 return( SPTree_LDeque::IsClosedArc( name ) );
 }

/*--------------------------------------------------------------------------*/

inline void SPTree_LDeque::SetOrigin( cIndex NewOrg )
{
...
inline void SPTree_LDeque::SetDest( cIndex NewDst )
{
...
//Johannes Sommer
//inline void SPTree_LDeque::SetDest( int i )
//{
//	if ( i == -1)
//	{
...
inline bool SPTree_LDeque::Reached( cIndex i )
{
...
inline unsigned int* SPTree_LDeque::Predecessors( void )
{
 return( NdePrd );
 }
...
inline MCFClass::Index SPTree_LDeque::DestN( void )
{
 return( NDsts );
 }
...
inline MCFClass::cIndex_Set SPTree_LDeque::Dests( void )
{
 return( DstBse );
 }
...
//Johannes Sommer
inline unsigned int* SPTree_LDeque::ArcPredecessors( void )
{
 CalcArcP();
 return( ArcPrd );
 }
...
//Johannes Sommer
inline void SPTree_LDeque::GetArcPredecessors( unsigned int *outArcPrd )
{
...
//Johannes Sommer
inline void SPTree_LDeque::GetPredecessors( unsigned int *outPrd )
{
	unsigned int size = MCFClass::MCFnmax()+1;
...
//Johannes Sommer
inline void SPTree_LDeque::GetDests( unsigned int *outDstBse )
{
	unsigned int size = MCFClass::MCFnmax()+1;
...
#endif  /* SPTree_LDeque.h included */

/*--------------------------------------------------------------------------*/
/*-------------------------- End File SPTree_LDeque.h -----------------------------*/
/*--------------------------------------------------------------------------*/
