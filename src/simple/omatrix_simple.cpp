...
int netxpert::simple::OriginDestinationMatrix::Solve()
{
    ...
    try
    {
        ...
        std::unordered_map<ODPair, CompressedPath> kvSPS = odm.GetShortestPaths();
        ...
        for (auto& kv : kvSPS)
        {
            ...
            unordered_set<string> arcIDlist = net.GetOriginalArcIDs(route, cnfg.IsDirected);
...
int netxpert::simple::OriginDestinationMatrix::Solve(bool doParallel)
{
    ...
    try
    {
        ...
        odm.SaveResults(cnfg.ResultTableName, cmap);
